...
public abstract class ExecutionEvent {
   ...
   * when a {@code CircuitBreaker} is open. Will return {@code 0} when the first attempt is in progress or has yet to
   * begin.
   */
  ...
  /**
   * Gets the number of completed executions so far. Executions that are blocked, such as when a {@code CircuitBreaker}
