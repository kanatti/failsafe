...
import dev.failsafe.*;
import dev.failsafe.testing.CircuitBreakerTesting;
 ...
 */
@Test
public class PolicyCompositionTest extends Testing implements CircuitBreakerTesting {
  /**
  ...
  public void testRetryPolicyCircuitBreakerWithOpenBreaker() {
    // Given
    RetryPolicy<Object> retryPolicy = withLogs(RetryPolicy.builder()).build();
    CircuitBreaker<Object> cb = withLogs(CircuitBreaker.builder()).build();
